...
// 🔥 More advanced AI logic (local — no API required)
function getSmartReply(message, history) {
  ...
  // --- 3. Memory-based contextual reply ---
  if (history.length > 1) {
...
const ChatWidget = () => {
  ...
  return (
<div className="w-full max-w-md mx-auto bg-slate-900 border border-slate-800 
rounded-2xl shadow-lg flex flex-col h-[32rem] overflow-hidden">
      {/* Messages */}
