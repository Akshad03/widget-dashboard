...
import FileUploadWidget from './components/FileUploadWidget'; // Import new widget
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="bg-[#1e293b] p-6 sm:p-8 rounded-2xl border border-gray-700/50 shadow-xl">
          <div className="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            ...
            <span className="text-xs bg-pink-500/10 text-pink-300 px-2 py-1 rounded">New</span>
          </div>
          <FileUploadWidget />
        </section>
