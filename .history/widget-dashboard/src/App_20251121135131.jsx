  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white p-4 sm:p-8 font-sans pb-20">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="bg-[#1e293b] p-6 sm:p-8 rounded-2xl border border-gray-700/50 shadow-xl mb-12">
      <div className="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
        <h2 className="text-xl font-semibold text-pink-400">06. AI Image Generator</h2>
        <span className="text-xs bg-gradient-to-r from-pink-500 to-purple-600 text-white px-2 py-1 rounded font-bold">
          BONUS TASK
        </span>
      </div>
      <AIWidget />
