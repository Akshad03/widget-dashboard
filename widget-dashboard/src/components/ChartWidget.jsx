      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex items-center gap-2 bg-[#0f172a] px-3 py-2 rounded-lg border border-gray-700 text-sm">
          ...
          <select 
            ...
            // FIXED: Removed 'bg-transparent' and added explicit dark background to the select
            className="bg-[#0f172a] outline-none text-gray-200 cursor-pointer text-sm p-1 rounded"
          >
            {/* FIXED: Added explicit background color to options so they don't turn white */}
            <option value="7d" className="bg-[#0f172a] text-white">Last 7 Days</option>
            <option value="1m" className="bg-[#0f172a] text-white">Last Month</option>
            <option value="1y" className="bg-[#0f172a] text-white">Last Year</option>
          </select>
        </div>
      </div>
