...
const NotificationWidget = () => {
  ...
  return (
    <div className="w-full font-sans text-white relative">
      ...
      {toast && (
        // CHANGED: 'absolute' -> 'fixed', '-top-24' -> 'top-4'
        <div className="fixed top-4 left-0 right-0 z-[100] flex justify-center pointer-events-none animate-in slide-in-from-top-5 fade-in duration-300">
          
          <div className="bg-[#0f172a] border border-teal-500/50 shadow-2xl shadow-teal-500/20 rounded-2xl p-4 flex items-start gap-4 w-full max-w-sm backdrop-blur-xl pointer-events-auto">
            ...
            <button onClick={() => setToast(null)} className="text-gray-500 hover:text-white transition">
              <X size={16} />
            </button>
          </div>
